...
<?php
     if(isset($_POST['enviado'])){ 
      ...
      $sql= "SELECT NICKMANE, FECHA_ACCESO from historial where FECHA_ACCESO >= '$fecha_ini' and FECHA_ACCESO <= '$fecha_fin';";
      echo"
            <div class=\"contenedor\" >                        
                <table width = \"100%\" >
                            <thead>
                                <tr>                                                
                                  ...
                                  <td><b><center>Fecha de acceso</center></b></td>                                         
                                </tr>
                            </thead>                                                                  
                </table>    
            </div>
                ...
                <table width = \"100%\" >   
                    <tbody>
                            <tr>     
                              ...
                              <td><center>".$consulta['FECHA_ACCESO']."</center></td>
                            </tr>
                    </tbody>                                                          
                </table>    
            </div>                       
